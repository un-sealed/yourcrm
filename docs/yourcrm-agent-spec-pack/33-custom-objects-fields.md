...
## 1. Purpose
No-code customization layer for CRM data.

## 2. Routes
/app/settings/objects, /app/settings/objects/:id

## 3. Scope / Feature Checklist
- [ ] Create/rename/archive custom objects.
- [ ] Custom fields of all supported types.
- [ ] Relationships between objects.
- [ ] Object icons and labels.
- [ ] Default views.
- [ ] Record layouts.
- [ ] Section/group configuration.
- [ ] Required/hidden/read-only fields.
- [ ] Field-level permissions.
- [ ] Validation rules.
- [ ] Duplicate-prevention rules.
- [ ] Formula/lookup/rollup fields.
- [ ] Object-specific timeline and activities.
- [ ] Import/export support.
- [ ] Automation triggers.
- [ ] API exposure.
- [ ] AI fields.
- [ ] Schema versioning and safe rollback.
...
## 6. Data Model
CustomObject, CustomField, Layout, LayoutSection, ValidationRule, FormulaDefinition.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
object/field/layout CRUD and metadata endpoints.
...
## 9. Domain Events
custom_object.created, custom_field.created, schema.updated.
...
Admins can extend the CRM without editing source code or running custom migrations.
