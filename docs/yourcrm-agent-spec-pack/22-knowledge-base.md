...
## 1. Purpose
Create searchable customer/internal documentation used by people and AI.

## 2. Routes
/app/knowledge-base, /app/knowledge-base/:id

## 3. Scope / Feature Checklist
- [ ] Spaces/categories.
- [ ] Articles with rich text, attachments and metadata.
- [ ] Draft/review/published lifecycle.
- [ ] Version history.
- [ ] Search.
- [ ] Public/private visibility.
- [ ] Customer-facing portal hook.
- [ ] Article feedback.
- [ ] Related articles.
- [ ] AI retrieval source with citations.
- [ ] AI support agent must cite source articles.
- [ ] Import markdown/document hook.
...
## 6. Data Model
KnowledgeSpace, Article, ArticleVersion, ArticleFeedback.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, publish, version, search, retrieval.
...
## 8. Permissions
space/article read/write/publish.
...
Articles are versioned, searchable and safe for AI retrieval.
