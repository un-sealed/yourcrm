...
## 1. Purpose
Create professional commercial proposals from CRM data.

## 2. Routes
/app/quotes, /app/quotes/:id, /app/quotes/:id/preview

## 3. Scope / Feature Checklist
- [ ] Quote builder with customer, deal, line items, discounts, taxes, terms and expiry.
- [ ] Reusable templates.
- [ ] PDF generation.
- [ ] Quote numbering.
- [ ] Versioning.
...
- [ ] View tracking.
- [ ] Accept/reject state.
- [ ] E-sign integration hook.
- [ ] Payment link hook.
- [ ] Automatic deal updates after acceptance/payment.
- [ ] AI quote summary and follow-up draft.
...
## 6. Data Model
Quote, QuoteVersion, QuoteLineItem, QuoteTemplate, QuoteViewEvent, Approval.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, preview, PDF, share link, acceptance, approval.
...
## 8. Permissions
quote creation, discount approval, financial fields.
...
A deal can produce a versioned quote and track its lifecycle.
