...
## 1. Purpose
Track customer issues and service commitments.

## 2. Routes
/app/tickets, /app/tickets/:id

## 3. Scope / Feature Checklist
- [ ] Ticket inbox with status, priority, assignee, team, SLA and customer.
- [ ] Ticket detail with conversation and timeline.
- [ ] Email-to-ticket.
- [ ] Unified inbox conversion to ticket.
...
- [ ] AI support agent draft with mandatory human handoff for configured actions.
...
## 6. Data Model
Ticket, TicketStatus, TicketPriority, SLA, SLAEvent, TicketMessage.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, assignment, SLA, merge/split, messaging.
...
## 8. Permissions
ticket/team/customer visibility; admin SLA configuration.
...
A support team can manage tickets from intake through resolution.
