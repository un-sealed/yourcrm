...
## 1. Purpose
Central notification and reminder system.
...
- [ ] Push/PWA notification hook.
- [ ] Digest preferences.
- [ ] Per-event preferences.
- [ ] Quiet hours.
- [ ] Deep links to source record.
- [ ] Bulk mark read.
...
## 7. API Requirements
list, mark read, preferences, delivery.
...
Important events reliably reach the correct user without notification spam.
