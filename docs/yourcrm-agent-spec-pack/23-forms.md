...
## 1. Purpose
Create embeddable forms that create CRM records.

## 2. Routes
/app/forms, /app/forms/:id, /forms/:publicId

## 3. Scope / Feature Checklist
- [ ] Visual form builder.
- [ ] Fields mapped to CRM objects.
- [ ] Required/optional and validation rules.
- [ ] Conditional fields.
- [ ] Hidden UTM/source fields.
- [ ] Consent checkbox.
- [ ] Spam protection/rate limiting/CAPTCHA hook.
- [ ] Success redirect/message.
- [ ] Assignment rules.
- [ ] Duplicate matching.
- [ ] Public share/embed code.
- [ ] Submission inbox.
- [ ] Webhook notification.
- [ ] Automatic lead creation and sequence enrollment.
- [ ] Analytics for views/submissions/conversion.
...
## 6. Data Model
Form, FormField, FormSubmission, FormVersion, SpamEvent.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, publish, public submit, submissions, analytics.
...
## 8. Permissions
form builder/publish/admin.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
form.published, form.submitted, lead.created_from_form.
...
A non-developer can publish a form that safely creates and routes leads.
