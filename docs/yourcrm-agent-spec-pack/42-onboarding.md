...
## 1. Purpose
Get a new workspace to first value quickly.
...
- [ ] Create booking page.
- [ ] Create first form.
- [ ] AI setup wizard that proposes fields, pipeline and automations.
- [ ] Progress checklist.
- [ ] Skip/resume.
- [ ] Completion tracking.
- [ ] Contextual help.
...
## 6. Data Model
OnboardingState, OnboardingStep, WorkspaceSetup.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
setup state, step completion, template application.
...
A new workspace can reach first deal or imported records in minutes.
