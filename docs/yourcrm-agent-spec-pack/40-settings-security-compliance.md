# Settings, Security, Compliance & Administration
...
## 6. Data Model
Workspace, SecurityPolicy, Role, Permission, Session, AuditEvent, RetentionPolicy, ConsentPolicy, BackupJob.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
admin CRUD and health endpoints.
...
## 9. Domain Events
security.setting_changed, user.invited, role.updated, audit.created.
...
Admins can configure the workspace without editing environment variables for normal business settings.
