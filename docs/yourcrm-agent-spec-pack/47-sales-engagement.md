...
## 1. Purpose
Run structured multi-step prospecting and follow-up.

## 2. Routes
/app/sequences, /app/sequences/:id

## 3. Scope / Feature Checklist
- [ ] Sequence builder.
- [ ] Email steps.
- [ ] Task/call steps.
- [ ] WhatsApp step where compliant.
- [ ] Delay/wait conditions.
- [ ] Business-day scheduling.
- [ ] Stop on reply.
- [ ] Stop on meeting booked.
- [ ] Stop on deal creation/won.
- [ ] Enrollment rules.
- [ ] Unsubscribe/consent enforcement.
- [ ] Round-robin ownership.
- [ ] Sequence analytics.
- [ ] Personalization variables.
- [ ] AI-generated step drafts.
...
## 6. Data Model
Sequence, SequenceStep, Enrollment, EnrollmentEvent.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, enroll, pause, resume, stop, analytics.
...
## 8. Permissions
sequence creation/send permissions.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
sequence.enrolled, sequence.step_executed, sequence.stopped, sequence.replied.
...
Sequences never continue after configured stop conditions.
