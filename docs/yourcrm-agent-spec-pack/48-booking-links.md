...
## 1. Purpose
Replace separate scheduling subscriptions for common CRM scheduling workflows.

## 2. Routes
/app/bookings, /book/:slug

## 3. Scope / Feature Checklist
- [ ] Personal booking page.
- [ ] Team round-robin page.
...
- [ ] Automatic deal/lead association.
...
## 6. Data Model
BookingPage, MeetingType, AvailabilityRule, Booking.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
public availability, create/cancel/reschedule, admin configuration.
...
## 8. Permissions
owner/team scheduling permissions.
...
Public booking page cannot expose private calendar details.
