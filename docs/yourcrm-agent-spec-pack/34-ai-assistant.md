# AI Assistant / Ask Your CRM

## 1. Purpose
Natural-language interface over permission-aware CRM data.
...
- [ ] Record lookup.
- [ ] Summarize accounts/deals/people.
- [ ] Find stalled deals and overdue work.
- [ ] Generate saved views.
- [ ] Generate charts/reports.
- [ ] Draft emails/messages.
- [ ] Create tasks and notes.
- [ ] Voice dictation.
- [ ] In-app access plus Slack and MCP entry points.
- [ ] Conversation history.
- [ ] Tool-call transparency.
- [ ] Source/citation display for retrieved data.
- [ ] User confirmation for write actions.
- [ ] Model selection.
- [ ] BYO OpenAI/Anthropic/Gemini/OpenRouter.
- [ ] Local Ollama/vLLM.
- [ ] Per-workspace model/cost limits.
- [ ] Prompt and tool audit logging.
...
## 7. API Requirements
chat, streaming, tool execution, model settings, usage.
...
## 8. Permissions
inherit user permissions; tool-specific scopes.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
ai.chat_started, ai.tool_called, ai.write_approved, ai.write_completed.
...
AI cannot retrieve or mutate data outside the user's permissions.
