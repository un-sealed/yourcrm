...
## 1. Purpose
Track post-sale health, renewals and retention.

## 2. Routes
/app/customers, /app/renewals, /app/health

## 3. Scope / Feature Checklist
- [ ] Customer lifecycle stage.
- [ ] Health score with explainable components.
- [ ] Renewal date and contract metadata.
- [ ] MRR/ARR fields.
- [ ] Expansion opportunities.
- [ ] Churn risk.
- [ ] NPS and CSAT.
- [ ] Customer success tasks/playbooks.
- [ ] Product usage signal ingestion.
- [ ] Renewal pipeline.
- [ ] Alerts for health deterioration.
- [ ] AI account health summary.
- [ ] Customer portal integration.
- [ ] Referral/partner relationship hook.
...
## 6. Data Model
CustomerProfile, HealthScore, Renewal, Contract, SurveyResponse, UsageSignal.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
health, renewals, surveys, usage ingestion.
...
## 8. Permissions
customer-success roles and record visibility.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
health.changed, renewal.upcoming, renewal.at_risk, survey.received.
...
Customer teams can identify upcoming renewals and act on health changes.
