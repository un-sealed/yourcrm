...
## 1. Purpose
Two-way calendar synchronization and CRM scheduling.

## 2. Routes
/app/calendar, /app/calendar/settings, /book/:slug

## 3. Scope / Feature Checklist
- [ ] Google Calendar and Microsoft Outlook two-way sync.
- [ ] Create/update/cancel meetings from CRM.
- [ ] Map attendees to people and companies.
- [ ] Auto-link meetings to records.
- [ ] Calendar day/week/month views.
- [ ] Availability lookup.
- [ ] Booking links.
- [ ] Round-robin booking.
- [ ] Team booking pools.
- [ ] Buffer times, working hours, minimum notice and booking limits.
- [ ] Timezone-aware scheduling.
- [ ] Automatic meeting reminders.
- [ ] ICS support.
- [ ] Meeting outcome logging.
- [ ] Future meeting-notes and notetaker hooks.
- [ ] Mobile calendar and booking management.
...
## 6. Data Model
CalendarConnection, CalendarEvent, BookingPage, AvailabilityRule, Booking.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
OAuth, sync, event CRUD, availability, booking endpoints.
...
## 8. Permissions
calendar connection per user; booking page ownership; team scheduling permissions.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
calendar.event_synced, booking.created, booking.cancelled, meeting.completed.
...
Two-way sync, conflict handling, booking links and automatic CRM linking.
