...
## 1. Purpose
Personal and team work management connected to CRM records.

## 2. Routes
/app/tasks, /app/tasks/:id

## 3. Scope / Feature Checklist
- [ ] Task list with today/upcoming/overdue views.
- [ ] Create task with title, description, due date, priority, owner, reminder and related records.
- [ ] Recurring tasks.
- [ ] Subtasks and checklists.
- [ ] Dependencies.
- [ ] Bulk complete/reassign/delete.
- [ ] Task comments and attachments.
- [ ] Task templates.
- [ ] Task creation from workflows, sequences and AI agents.
- [ ] Notifications and reminders.
- [ ] Mobile quick completion and creation.
- [ ] AI prioritization and daily task summary.
...
## 6. Data Model
Task, TaskChecklistItem, TaskDependency, Reminder, Recurrence.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, complete/reopen, bulk, recurrence, dependencies.
...
## 8. Permissions
owner/team/all visibility; assignment permissions.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
task.created, task.completed, task.overdue, task.reassigned.
...
Tasks reliably sync with timelines, notifications, workflows and mobile.
