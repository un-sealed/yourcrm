...
## 1. Purpose
Unified chronological record of work and customer interactions.

## 2. Routes
/app/activities, /app/activities/:id, /app/:object/:id/timeline

## 3. Scope / Feature Checklist
- [ ] Unified timeline for emails, calls, meetings, notes, tasks, files, field changes and messages.
- [ ] Activity types with configurable metadata.
- [ ] Create activity from any record.
- [ ] Rich notes with mentions and attachments.
- [ ] Internal vs customer-visible activities.
- [ ] Timeline filters by type, actor and date.
- [ ] Pin important activity.
- [ ] Edit/delete with audit trail.
- [ ] Activity threading and comments.
- [ ] Automatic activity creation from integrations.
- [ ] AI-generated summaries and suggested next steps.
- [ ] Activity deduplication for synced messages.
- [ ] Mobile timeline with quick compose.
...
## 6. Data Model
Activity, ActivityType, ActivityParticipant, Comment, Attachment.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
timeline query, create/update/delete activity, comments, attachments.
...
## 8. Permissions
record-level inherited permissions plus internal/customer visibility.
...
Every supported domain can attach a consistent timeline and activity composer.
