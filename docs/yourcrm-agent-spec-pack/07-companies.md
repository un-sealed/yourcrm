...
## 1. Purpose
Account/company 360 and organization hierarchy.

## 2. Routes
/app/companies, /app/companies/:id

## 3. Scope / Feature Checklist
- [ ] Account table with saved views and inline edits.
- [ ] Company profile with domain, industry, size, locations, owner, tags, custom fields and related people.
- [ ] Parent/child account hierarchy.
- [ ] Multiple domains and aliases for email matching.
- [ ] Account timeline combining people, deals, activities, communications and files.
- [ ] Account contacts and role labels.
- [ ] Duplicate detection and merge.
- [ ] Import/export and bulk operations.
- [ ] Account segmentation and dynamic lists.
- [ ] AI account summary and research fields with source URL/date.
- [ ] Buying signals and product-usage signal hooks.
- [ ] Customer health and renewal fields for future customer-success module.
- [ ] Map/location hook for field sales.
- [ ] Mobile account lookup and quick actions.
...
## 6. Data Model
Company, CompanyDomain, CompanyLocation, CompanyPersonRole, AccountHierarchy, Segment membership.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
CRUD, hierarchy, contacts, timeline, merge, search, bulk actions, import/export.
...
## 8. Permissions
same object/record/field model as People.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
company.created, company.updated, company.merged, company.hierarchy_changed.
...
Account hierarchy, contact roles, duplicate merge, timeline, search, filters, bulk actions, mobile detail.
