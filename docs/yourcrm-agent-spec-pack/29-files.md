...
## 1. Purpose
Centralize CRM attachments and reusable documents.

## 2. Routes
/app/files, /app/files/:id

## 3. Scope / Feature Checklist
- [ ] S3-compatible storage.
- [ ] Folders and record attachments.
- [ ] Preview for common file types.
- [ ] Metadata and file size/type.
- [ ] Secure signed URLs.
- [ ] Access inheritance from linked record.
- [ ] Upload progress and retry.
- [ ] Versioning for reusable documents.
- [ ] Delete/restore lifecycle.
- [ ] Virus-scanning hook.
- [ ] Retention rules.
- [ ] Bulk download/export.
- [ ] AI OCR and document extraction hook.
- [ ] Quote/proposal template storage.
- [ ] Customer portal sharing hook.
...
## 6. Data Model
File, FileVersion, Folder, FileLink, ShareLink.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
upload, download URL, metadata, version, share, delete/restore.
...
## 8. Permissions
record-inherited and explicit share permissions.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
file.uploaded, file.linked, file.deleted, file.restored.
