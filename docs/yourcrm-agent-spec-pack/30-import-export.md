...
## 1. Purpose
Make switching from spreadsheets and competing CRMs easy.

## 2. Routes
/app/import-export, /app/settings/migrations

## 3. Scope / Feature Checklist
- [ ] CSV and Excel import.
- [ ] Preview and row validation.
- [ ] Field mapping with saved mappings.
- [ ] Create/update/upsert modes.
- [ ] Duplicate detection.
- [ ] Merge suggestions.
- [ ] Relationship import.
- [ ] Tag import.
- [ ] Attachment import hook.
- [ ] Full CSV/JSON export.
- [ ] Workspace backup export.
- [ ] Migration connectors for HubSpot, Salesforce, Pipedrive, Zoho and spreadsheets.
- [ ] Migration report with counts, skipped rows and errors.
- [ ] Dry run.
- [ ] Resume failed imports.
- [ ] Background processing.
- [ ] Permission-aware exports.
- [ ] Encryption for temporary import files.
...
## 6. Data Model
ImportJob, ImportMapping, ImportRowError, ExportJob, MigrationJob.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
upload, preview, validate, execute, status, export, migration connector.
...
## 8. Permissions
import/export admin rights and object visibility.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
import.started, import.completed, import.failed, export.created.
...
A typical CRM can be migrated without manually recreating records.
