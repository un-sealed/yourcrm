...
## 1. Purpose
Make core CRM workflows genuinely usable on phones.

## 2. Routes
/app/* responsive; installable PWA

## 3. Scope / Feature Checklist
- [ ] Responsive app shell.
- [ ] Installable PWA.
- [ ] Offline-aware read cache.
- [ ] Quick create person/company/lead/deal/task.
- [ ] Log call.
- [ ] Open WhatsApp.
- [ ] Send email.
- [ ] Scan business card.
...
- [ ] Offline queue for safe mutations with conflict resolution.
- [ ] Native React Native/Expo migration path later.
...
## 6. Data Model
OfflineMutation, SyncCursor, DeviceSession.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
sync endpoints and push registration.
...
## 9. Domain Events
mobile.sync_started, mobile.sync_conflict, mobile.action_queued.
...
Core daily workflows work comfortably on a phone and PWA installation is reliable.
