...
## 1. Purpose
Find any CRM record quickly and execute actions from one interface.

## 2. Routes
/app/search, global Cmd/Ctrl+K

## 3. Scope / Feature Checklist
- [ ] Global search across people, companies, leads, deals, activities, tasks, files and custom objects.
- [ ] Prefix/type filters.
- [ ] Fuzzy matching.
- [ ] Recent searches.
- [ ] Recently viewed.
...
- [ ] Quick assign.
- [ ] Quick note/task.
- [ ] Search within conversations and knowledge base.
- [ ] Permission-aware results.
- [ ] AI natural-language search.
- [ ] AI query-to-saved-view/report.
- [ ] Indexing status and reindex admin control.
...
## 6. Data Model
SearchIndex, SearchPreference, RecentItem.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
search, autocomplete, command execution.
...
User can find a record or perform common action without leaving keyboard flow.
