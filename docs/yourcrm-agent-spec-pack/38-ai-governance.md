# AI Governance, Audit & Safety

## 1. Purpose
Central safety layer for all AI writes and autonomous actions.

## 2. Routes
/app/settings/ai/governance, /app/ai/activity

## 3. Scope / Feature Checklist
- [ ] Permission inheritance.
- [ ] Per-agent object/field scopes.
- [ ] Approval queue.
- [ ] External-send approval policy.
- [ ] Bulk update/delete approval policy.
- [ ] Action audit log with before/after diff.
- [ ] Prompt/model/tool metadata.
- [ ] One-click undo where reversible.
- [ ] Token/cost caps.
- [ ] Usage alerts.
- [ ] Agent health dashboard.
- [ ] Source attribution for research.
- [ ] Local-model-only privacy mode.
- [ ] PII redaction before external model calls.
- [ ] Data retention controls.
- [ ] Model cards/transparency documentation.
- [ ] Kill switch for an agent/workspace.
- [ ] Feature flags for experimental AI.
...
## 6. Data Model
AIAuditEvent, AIPolicy, AICostLimit, AIApproval, AIUndoAction.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
policy CRUD, approvals, audit query, usage, kill switch.
...
## 9. Domain Events
ai.policy_changed, ai.approval_requested, ai.action_reverted, ai.kill_switch_enabled.
...
Every AI write is traceable and bounded.
