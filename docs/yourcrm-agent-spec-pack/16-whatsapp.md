...
## 1. Purpose
First-class WhatsApp Business communication and lead channel.
...
- [ ] Template message management and approval status.
- [ ] Text, image, document, audio and supported interactive messages.
- [ ] Conversation assignment.
- [ ] Auto-create/link person, company and lead.
- [ ] Lead source attribution.
- [ ] Bulk campaign support with opt-in/consent controls.
- [ ] Opt-out handling.
- [ ] Delivery/read/error states.
- [ ] Webhook verification and retry.
- [ ] Workflow triggers from inbound/outbound messages.
- [ ] AI qualification bot with human handoff.
- [ ] AI translation for regional languages.
- [ ] Agent actions require configured scopes and approval rules.
...
## 6. Data Model
WhatsAppAccount, WhatsAppTemplate, Conversation, Message, Consent, DeliveryStatus.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
Meta webhook, send message, template sync, account setup, conversation APIs.
...
## 8. Permissions
admin connection management; agent send scope; user/team conversation access.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
whatsapp.message_received, whatsapp.message_sent, whatsapp.template_updated, whatsapp.opted_out.
...
Secure webhook ingestion, reliable messaging, CRM linking and human-controlled AI automation.
