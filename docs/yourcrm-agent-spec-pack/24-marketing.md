...
## 1. Purpose
Segmentation and campaigns without building a full marketing automation suite.

## 2. Routes
/app/marketing, /app/marketing/segments, /app/marketing/campaigns

## 3. Scope / Feature Checklist
- [ ] Static and dynamic segments.
- [ ] Filter-based audience builder.
...
- [ ] Performance metrics.
- [ ] Sequence/cadence integration.
- [ ] WhatsApp campaign integration with template/consent rules.
- [ ] AI campaign copy suggestions.
- [ ] Do not allow AI to bypass opt-out or consent.
...
## 6. Data Model
Segment, SegmentMembership, Campaign, CampaignMessage, CampaignEvent, Consent.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
segment evaluation, campaign CRUD, scheduling, metrics.
...
## 8. Permissions
marketing access; export; campaign send.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
segment.updated, campaign.scheduled, campaign.sent, campaign.unsubscribed.
...
Teams can build compliant segments and simple campaigns.
