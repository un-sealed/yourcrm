...
## 1. Purpose
CRM-integrated telephony and call logging.

## 2. Routes
/app/calling, /app/settings/calling

## 3. Scope / Feature Checklist
- [ ] Provider adapters for Twilio, Exotel, Plivo and India-focused providers.
- [ ] Click-to-call.
- [ ] Inbound call routing hook.
- [ ] Automatic call logging.
- [ ] Call recording metadata and provider URL.
- [ ] Call duration, direction and outcome.
- [ ] Call notes and follow-up task.
- [ ] Unknown caller matching and create-contact flow.
- [ ] Call queue/history.
- [ ] Provider error/retry handling.
- [ ] Consent/recording policy configuration.
- [ ] AI transcription and summary hook.
- [ ] Conversation intelligence hook.
- [ ] Regional language support hook.
...
## 6. Data Model
PhoneAccount, Call, CallParticipant, CallRecording, CallOutcome.

All records must follow the shared conventions in `03-data-model.md`.

## 7. API Requirements
provider connection, initiate call, webhooks, logs, recordings.
...
## 8. Permissions
provider admin; call visibility; recording access; outbound calling.

Permission checks must occur server-side. UI hiding is not a security boundary.

## 9. Domain Events
call.started, call.answered, call.completed, call.recording_ready.
...
Click-to-call and automatic logging work with at least one provider.
